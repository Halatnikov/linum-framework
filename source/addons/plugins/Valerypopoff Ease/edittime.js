...
function GetPluginSettings()
{
	...
	return {
		...
		"version":		"2.1.0",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
...
AddStringParam("Ease tag", "Ease tag."
);	
...
AddVariadicParams("Ease parameter {n}", "Parameter that will be accessible from triggers, conditions and expressions."
);	
...
AddVariadicParams("Ease parameter {n}", "Parameter that was passed to the Ease Action."
);	
...
AddCondition(1, cf_trigger, "On finished", "General", "On {0}({...}) finished", "Triggered when easing is finished.", "OnFinished");
...
AddCondition(3, cf_trigger, "On ticked", "General", "On {0}({...}) ticked", "Triggered when easing is ticked.", "OnTicked");
...
AddExpression(0, ef_return_number | ef_variadic_parameters, "Time Progress of any easing", "General", "TimeProgress", "Get the time progress of any easing.");

AddStringParam("Ease tag", "Ease tag."
);	

AddExpression(1, ef_return_number | ef_variadic_parameters, "Value of any easing", "General", "CurrentValue", "Get the current value of any easing.");

AddNumberParam("Parameter index", "Parameter index."
, "0"
);	

AddExpression(2, ef_return_any, "Finised Parameter", "General", "FinishedParam", "Get the parameter of a finished easing.");

AddNumberParam("Parameter index", "Parameter index."
, "0"
);	

AddExpression(3, ef_return_any, "Ticked Parameter", "General", "TickedParam", "Get the parameter of a ticked easing.");

AddExpression(4, ef_return_number, "Ticked Value", "General", "TickedValue", "Get the value of a ticked easing.");

AddExpression(5, ef_return_number, "Ticked Time Progress", "General", "TickedTimeProgress", "Get the time progress of a ticked easing.");
