...
/////////////////////////////////////
// Behavior class
cr.behaviors.Rex_animation_loaderEDIT = function(runtime)
{
...
(function ()
{
	var behaviorProto = cr.behaviors.Rex_animation_loaderEDIT.prototype;
	...
	behinstProto.request_url = function (animation_name, frame_index)
	{
        ...
        this.exp_URL = "";
        this.runtime.trigger(cr.behaviors.Rex_animation_loaderEDIT.prototype.cnds.OnGetURL, this.inst);
        return this.exp_URL;
	};
	...
	behinstProto.on_frame_loaded = function (animation_name, frame_index, url_, is_success, loader_task)
	{
        ...
        if ( is_success )
            this.runtime.trigger(cr.behaviors.Rex_animation_loaderEDIT.prototype.cnds.OnFrameLoaded, this.inst);
        else
            this.runtime.trigger(cr.behaviors.Rex_animation_loaderEDIT.prototype.cnds.OnFrameLoadedFailed, this.inst);
            
       loader_task.removeWait( event_name_get(animation_name, frame_index) );
       if ( !loader_task.isWaitting() )
        {
            this.runtime.trigger(cr.behaviors.Rex_animation_loaderEDIT.prototype.cnds.OnAllAnimationLoaded, this.inst);
        }
	};
